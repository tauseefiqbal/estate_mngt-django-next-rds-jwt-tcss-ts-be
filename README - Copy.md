...
- [Alpha Apartments — Estate Management System](#alpha-apartments--estate-management-system)
  ...
  - [Getting Started](#getting-started)
    ...
    - [2. Backend Setup](#2-backend-setup)
      - [2.1 Create \& Activate Virtual Environment](#21-create--activate-virtual-environment)
      - [2.2 Install Dependencies](#22-install-dependencies)
      - [2.3 Configure Environment Variables](#23-configure-environment-variables)
      - [2.4 Run Migrations \& Create Superuser](#24-run-migrations--create-superuser)
      - [2.5 Load Sample Data (Optional)](#25-load-sample-data-optional)
...
```bash
git clone https://github.com/tauseefiqbal/estate_mngt-django-next-rds-jwt-tcss-ts-be.git 
cd estate_mngt-django-next-rds-jwt-tcss-ts-be
```
