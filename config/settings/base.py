...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "API for managing estate apartments, issues, posts, and ratings",
    "VERSION": "1.0.0",
...
# Disable error email logging during tests to avoid Python 3.14 template context issues
if TESTING:
    # Disable DEBUG to prevent template error rendering
    DEBUG = False
    
    # Use custom test runner that disables template context capturing (Python 3.14 fix)
    TEST_RUNNER = 'config.test_runner.Python314CompatibleTestRunner'
    
    # Override template settings to prevent instrumentation
