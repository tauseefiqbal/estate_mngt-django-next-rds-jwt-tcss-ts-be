...
class Issue(TimeStampedModel):
    ...
    def save(self, *args, **kwargs) -> None:
        ...
        self.description = sanitize_html_content(self.description)

        # Validate content lengths
        validate_content_length(self.title, min_length=5, max_length=255)
        validate_content_length(self.description, min_length=10, max_length=5000)
    ...
    class Meta:
        ...
        ordering = ["-created_at"]
        indexes = [
            models.Index(fields=["status", "-created_at"], name="issue_status_idx"),
            models.Index(fields=["priority", "-created_at"], name="issue_priority_idx"),
            models.Index(fields=["assigned_to", "status"], name="issue_assigned_idx"),
            models.Index(fields=["apartment", "-created_at"], name="issue_apartment_idx"),
        ]
