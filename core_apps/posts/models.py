...
class Post(TimeStampedModel):
    ...
    def save(self, *args, **kwargs) -> None:
        ...
        self.title = sanitize_html_content(self.title)
        self.body = sanitize_html_content(self.body)

        # Validate content lengths
        validate_content_length(self.title, min_length=5, max_length=250)
        validate_content_length(self.body, min_length=10, max_length=10000)
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["-upvotes", "-created_at"], name="post_popular_idx"),
...
class Reply(TimeStampedModel):
    ...
    def save(self, *args, **kwargs) -> None:
        # Sanitize reply content before saving
        self.body = sanitize_html_content(self.body)
        validate_content_length(self.body, min_length=2, max_length=5000)
        super().save(*args, **kwargs)
    ...
    class Meta:
        ...
        ordering = ["-created_at"]
        indexes = [
            models.Index(fields=["post", "-created_at"], name="reply_post_idx"),
            models.Index(fields=["author", "-created_at"], name="reply_author_idx"),
        ]
